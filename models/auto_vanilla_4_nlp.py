...
class AutoVanilla4NLP(ContinualModel):
    """
    feature: with logits regularization; start from instance
    """
    NAME = 'autovanilla4nlp'
    COMPATIBILITY = ['class-il', 'domain-il', 'task-il', 'general-continual']
    
    def __init__(self, backbone, loss, args, transform):
        super(AutoVanilla4NLP, self).__init__(backbone, loss, args, transform)
    ...
    def observe(self, inputs, inputs_mask, labels, labels_name=None, labels_mask=None, task_labels=None):
        ...
        features = self.net.sentence_hidden(encoding, self.proto_layers)  # batch_size * 768
